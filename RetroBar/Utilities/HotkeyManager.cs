...
namespace RetroBar.Utilities
{
    public class HotkeyManager : IDisposable
    {
        ...
        {
            listenerWindow = new HotkeyListenerWindow();
        ...
        public static event EventHandler<TaskbarHotkeyEventArgs> TaskbarHotkeyPressed;
        ...
        static readonly byte[] explorerHotkeySearchPattern = { // 4 entries should be enough to uniquely identify the hotkey table
        ...
        private static int FindExplorerTaskbarHotkeyIndex()
        {
            int index = 0;
            ...
            protected override void WndProc(ref Message m)
            {
                if (m.Msg == (int)NativeMethods.WM.HOTKEY)
                {
                    ...
                    if (hotkeyId >= 0 && hotkeyId <= 9) // 0-9: Quick switch hotkeys
                    {
                        ...
                        TaskbarHotkeyPressed?.Invoke(this, args);
                    }
                }
